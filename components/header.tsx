          ...
          <nav>
            <ul className="flex flex-wrap justify-center gap-[50px] md:gap-4">
              ...
              <div className="hidden xl:flex">
                <a
                    href="https://wa.me/011123344" // Reemplaza con el número de teléfono
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center bg-blue-500 text-white rounded-full p-2 hover:bg-blue-400 transition-colors hover:scale-105 shadow-lg"
                  >
                    {/* SVG de WhatsApp */}
                    <svg
                    ...
                    <span className="ml-2">011 435867</span> {/* Número de teléfono */}
                  </a>
              </div>
            </ul>
          </nav>
