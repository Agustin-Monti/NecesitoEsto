...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  for (const demanda of demandas) {
    const mailOptions = {
      ...
      text: `Hola, tu demanda "${demanda.detalle}" está por vencer en 2 días. Te recomendamos renovar la fecha para que siga activa y aparezca en el portal demandas, puedes editar la fecha o bien eliminar la demanda si ya no es necesaria. Gracias, Team-Necesito`,
    };
